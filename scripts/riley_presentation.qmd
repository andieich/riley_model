...
|-------------------------------------|------------------|------------------|
| $\textcolor{#B3541E}{p}$ | 2.5 $\mathrm{gC(gC)^{-1}d^{-1}}$ | photosynthetic rate per unit irradiance |

| **Forcing variable** | **Unit** | **Meaning** |
|-----------------------------------------|----------------|----------------|
| $\textcolor{#2B5F9E}{I_0}$ |  | Light at seasurface |
| $\textcolor{#2B5F9E}{k}$ |  | extinction coefficient |
| $\textcolor{#2B5F9E}{z_\text{euph}}$ |  | depth of the euphotic zone |
| $\textcolor{#2B5F9E}{L_\text{N}}$ |  | limiting effects of turbulence |
| $\textcolor{#2B5F9E}{L_\text{V}}$ |  | limiting effects of nutrients |

| **Parameter** | **Value** | **Meaning** |
|:--------------------------:|:-------------------:|:-----------------------|
| [$\textcolor{#B3541E}{p}$]{style="display:inline-block; width:20px; text-align:center;"} | 2.5 $\mathrm{gC(gC)^{-1}d^{-1}}$ | photosynthetic rate per unit irradiance |
| [$\textcolor{#B3541E}{r}$]{style="display:inline-block; width:20px; text-align:center;"} | 0.3 $\mathrm{d^{-1}}$ | specific growth rate |
